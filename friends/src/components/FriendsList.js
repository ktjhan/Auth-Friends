...
export default function FriendList(props) {
    ...
    return (
        <div className="friendList">
         <Typography variant="h3">I have nobody...</Typography>
         <Grid container spacing="3">
         {
             friends.map(each => (
                 <Grid item>
                <Friends id={each.id} name={each.name} age={each.age} email={each.email} handleDelete={handleDelete} handleEdit={handleEdit}/>
                </Grid>
             ))
         }
